...
class UserControllerTest {
    ...
    WebApplicationContext는 ApplicationContext를 상속 받은 타입으로, 웹 어플리케이션과 관련된
    정보를 가진다.
    서버를 실행하지 않고 컨트롤러를 확인하려면 가짜 요청을 보내야한다.
    ...
    MockMvc객체를 만들기 위해 필요한 것이 WebApplicationContext객체이다.
     */
